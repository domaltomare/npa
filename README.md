...
Le regole di validazione sintattica (tipo e obbligatorietà del campo) sono definte nelle [specifiche]([/docs/modello-dati/regole/](#specifiche-delle-interfacce)
